...
class _$MenuItemImpl implements _MenuItem {
  ...
  @override
  String toString() {
    return 'MenuItem(id: $id, name: $name, description: $description, price: $price, tags: $tags, imageUrl: $imageUrl)';
  }
...
abstract class _MenuItem implements MenuItem {
  const factory _MenuItem(
      ...
      final List<String>? tags,
      final String? imageUrl}) = _$MenuItemImpl;
...
abstract class $MenuPayloadCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Category> categories, List<MenuItem> items});
}
...
class _$MenuPayloadImpl implements _MenuPayload {
  ...
  @override
  String toString() {
    return 'MenuPayload(categories: $categories, items: $items)';
  }
...
abstract class _MenuPayload implements MenuPayload {
  const factory _MenuPayload(
      {required final List<Category> categories,
      required final List<MenuItem> items}) = _$MenuPayloadImpl;
